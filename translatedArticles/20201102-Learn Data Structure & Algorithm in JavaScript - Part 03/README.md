原文链接：[Learn Data Structure & Algorithm in JavaScript | Part 02](https://dev.to/edisonnpebojot/learn-data-structure-and-algorithm-in-javascript-part-03-44h8 "学习JavaScript中的数据结构和算法 | 第03部分") <br/>
